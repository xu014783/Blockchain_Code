...
namespace BlockchainAssignment
{
    class Transaction
    {
        ...
        private DateTime timestamp; // Time of creation, private field
        ...
        // Public property to access the timestamp
        public DateTime Timestamp
        {
            get { return timestamp; }
            // If you need to be able to set it from outside, add a set accessor here.
        }
